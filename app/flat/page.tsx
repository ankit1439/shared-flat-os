...
const LINKS = [
  ...
  { href: "/money/add", title: "Add expense", desc: "Log any shared spend" },
  { href: "/money/add?type=milk", title: "Quick: Milk", desc: "Log today’s milk" },
  { href: "/money/add?type=vegetables", title: "Quick: Vegetables", desc: "Log sabzi purchase" },
